...
public class AnotacoesSalvasFiltroCartao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anotacoes_salvas_filtro_cartao);

        // Inicializar o Firebase Analytics
        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);

        if (!BuildConfig.DEBUG) {
            logPageViewEvent("AnotacoesSalvasFiltroCartao");
        }

        context10 = this; // ou use getApplicationContext() se necessário
        // Recupere o valor da Intent
        Intent intent11 = getIntent();
        nome_cartao = intent11.getStringExtra("chave_string");
        ...
        myDB10 = new MyDatabaseHelper(AnotacoesSalvasFiltroCartao.this);
        ...
        customAdapter = new CustomAdapter(AnotacoesSalvasFiltroCartao.this,AnotacoesSalvasFiltroCartao.this, book_id10, book_title10,book_author10,book_pages10,book_date10,book_despesa_ou_receita10,book_categoria10,book_pago_ou_nao_pago10,book_red_flag_notification10);
        recyclerView10.setAdapter(customAdapter);

        storeDataInArrays_using_filter(year_monthh10,nome_cartao);
        ...
        double total_despesa_por_cartao = myDB10.somaFaturaDoMesPorCartao(year_month, nome_cartao, "DESPESA COM CARTÃO");
        NumberFormat numberFormat = NumberFormat.getNumberInstance();
        numberFormat.setMinimumFractionDigits(2); // Para garantir que sempre tenha duas casas decimais
        String formattedtotalSum = numberFormat.format(total_despesa_por_cartao);
        ...
        String concatenatedText = nome_cartao + ": " + moedaSelecionada + " " + formattedtotalSum;
        ...
        customAdapter = new CustomAdapter(AnotacoesSalvasFiltroCartao.this,AnotacoesSalvasFiltroCartao.this, book_id10, book_title10,book_author10,book_pages10,book_date10,book_despesa_ou_receita10,book_categoria10,book_pago_ou_nao_pago10,book_red_flag_notification10);
        recyclerView10.setAdapter(customAdapter);
        recyclerView10.setLayoutManager(new LinearLayoutManager(AnotacoesSalvasFiltroCartao.this));
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                storeDataInArrays_using_filter(year_month10,nome_cartao);



                // ----------------- INIT - SETANDO O NOME DO CARTAO NA PAGINA E O VALOR DA FATURA ----------------------//
                double total_despesa_por_cartao = myDB10.somaFaturaDoMesPorCartao(year_month10, nome_cartao, "DESPESA COM CARTÃO");
        ...
        btnBefore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                storeDataInArrays_using_filter(year_month,nome_cartao);
    ...
    void storeDataInArrays_using_filter(String year_month, String nome_cartao){

        Cursor cursor = myDB10.readDataFilter_cartao(year_month, nome_cartao);
    ...
    private void updateRecyclerView() {
        ...
        Intent intent33 = new Intent(AnotacoesSalvasFiltroCartao.this, AnotacoesSalvas.class);
